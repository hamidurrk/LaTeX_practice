...
%---------------------------------------------------------
  \cventryprojects
    ...
    {2023} % Date(s)
    {
      ...
      {2022} % Date(s)
      {
        ...
        {2018} % Date(s)
        {
          \begin{cvitems} % Project Description(s)
            ...
            \item {\underline{Utilized:} C++, Python, Arduino, ESP-32, Tacile Feedback Motors, Type-C Charging, BLE \& WiFi Communication, 3D printing.}
          \end{cvitems}
          }
        %---------------------------------------------------------
        \cventryprojects
      ...
      %---------------------------------------------------------
      \cventryprojects
      {My portfolio for showcasing other skills \& projects (\href{https://hamidurrk.com}{hamidurrk.com})} % Brief Description
